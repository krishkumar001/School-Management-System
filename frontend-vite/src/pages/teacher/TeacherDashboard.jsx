...
const TeacherDashboard = () => {
    ...
    // Add a loading state for demonstration (replace with real loading logic as needed)
    const loading = false;
    ...
    return (
        <>
            <Box sx={{ display: 'flex' }}>
                ...
                <Drawer variant="permanent" open={open} sx={{ width: 240, flexShrink: 0 }}>
                ...
                <Box component="main" sx={{ ...styles.boxStyled, ml: open ? 30 : 0, pt: 8, px: 3 }}>
                    <Toolbar />
                    {loading ? (
                        <Box sx={{ p: 3 }}>
