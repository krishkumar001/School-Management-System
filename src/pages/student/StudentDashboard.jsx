            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <Box component="main" sx={styles.boxStyled}>
                    ...
                    <MainContainer>
                        ...
                        <Grid container spacing={3} sx={{ mt: 2 }}>
                            <Grid item xs={12} md={4}>
                                <InfoCard>
                                    ...
                                    <Button href="/Student/attendance" endIcon={<ArrowForwardIosIcon />} sx={{ mt: 1, color: '#ff8c42', fontWeight: 600 }}>
                                        View Attendance
                                    </Button>
                                </InfoCard>
                            </Grid>
                            <Grid item xs={12} md={4}>
                                <InfoCard>
                                    ...
                                    <Button href="/Student/subjects" endIcon={<ArrowForwardIosIcon />} sx={{ mt: 1, color: '#ff8c42', fontWeight: 600 }}>
                                        View Subjects
                                    </Button>
                                </InfoCard>
                            </Grid>
                            <Grid item xs={12} md={4}>
                                <InfoCard>
                                    ...
                                    <Button href="/Student/messages" endIcon={<ArrowForwardIosIcon />} sx={{ mt: 1, color: '#ff8c42', fontWeight: 600 }}>
                                        View Messages
                                    </Button>
                                </InfoCard>
                            </Grid>
                        ...
                        <QuickLinksContainer>
                            <Button variant="contained" href="/Student/profile" sx={quickLinkBtn}>Profile</Button>
                            <Button variant="contained" href="/Student/subjects" sx={quickLinkBtn}>Subjects</Button>
                            <Button variant="contained" href="/Student/attendance" sx={quickLinkBtn}>Attendance</Button>
                            <Button variant="contained" href="/Student/complain" sx={quickLinkBtn}>Complaints</Button>
                            <Button variant="contained" href="/Student/messages" sx={quickLinkBtn}>Messages</Button>
                        </QuickLinksContainer>
                    </MainContainer>
                </Box>
            </Box>
