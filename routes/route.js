...
const {
    ...
    getAttendanceAnalytics } = require('../controllers/student_controller.js');
...
const { parentRegister, parentLogin, getParentChildren, getParentNotices, updateParent } = require('../controllers/parent-controller.js');
const { sendMessage, getMessages, getConversation, markAsRead } = require('../controllers/message-controller.js');
